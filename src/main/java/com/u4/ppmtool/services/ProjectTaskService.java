...
public class ProjectTaskService {
    ...
    public List<ProjectTask> fetchBacklogTasks(String backlogId) {
    ...
    public ProjectTask updateByProjectSequence(String backlogId, String sequence, ProjectTask updatedTask) {
